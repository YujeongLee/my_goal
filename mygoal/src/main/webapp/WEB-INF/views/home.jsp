...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/goal/resources/css/js-mindmap.css" />
  <link type="text/css" rel="stylesheet" href="/goal/resources/css/style.css" />
  ...
  <script type="text/javascript" src="/goal/resources/js/raphael-min.js"></script>

  <!-- Mindmap -->
  <script type="text/javascript" src="/goal/resources/js/js-mindmap.js"></script>

  <!-- Kick everything off -->
  <script src="/goal/resources/js/script.js" type="text/javascript"></script>
